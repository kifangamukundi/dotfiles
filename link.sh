...
remove_symlink_if_exists "$CONFIG_DIR/fontconfig"
remove_symlink_if_exists "$CONFIG_DIR/xdg-desktop-portal"
...
create_symlink "$DOTFILES_DIR/.config/nvim-lazy" "$CONFIG_DIR/nvim-lazy"
create_symlink "$DOTFILES_DIR/.config/nvim-server" "$CONFIG_DIR/nvim-server"
...
create_symlink "$DOTFILES_DIR/.config/mpv" "$CONFIG_DIR/mpv"
create_symlink "$DOTFILES_DIR/.config/fontconfig" "$CONFIG_DIR/fontconfig"
